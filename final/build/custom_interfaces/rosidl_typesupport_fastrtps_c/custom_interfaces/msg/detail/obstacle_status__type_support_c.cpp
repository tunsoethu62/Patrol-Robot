...
#include "custom_interfaces/msg/detail/obstacle_status__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleStatus__ros_msg_type = custom_interfaces__msg__ObstacleStatus;
...
static uint32_t _ObstacleStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__ObstacleStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__ObstacleStatus;
    is_plain =
      (
...
static size_t _ObstacleStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__ObstacleStatus(
